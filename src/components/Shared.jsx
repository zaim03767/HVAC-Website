...
export function WAFab() {
  ...
  return (
    <button className="wa-fab" onClick={wa} title="Chat on WhatsApp">
...
export function PageHero({ title, subtitle, page, setPage }) {
  return (
      ...
      <div className="page-hero">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-center gap-2.5 mb-4">
            ...
            <span className="text-blue-300 text-xs font-bold tracking-[1.5px] uppercase">
